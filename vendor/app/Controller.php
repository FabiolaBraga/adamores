...
class Controller extends Url implements  InterfaceController {
    ...
    public function load($actionName, $theme, $className, $frontend) {
        ...
        if(MODULES){ 
              $modules = '/modules/'.$render.'';
              $theme= '';
        }
        
        $controller = $modules. CONTROLLER . $theme. $className;
        ...
        if (file_exists(WWW_ROOT . '/' . $controller . '.php')) {
            ...
            $controller = $modules. CONTROLLER . $theme . ucfirst($theme) . 'Controller';
    ...
    private function Actions($_namespace, $actionName, $frontend) {
        ...
        if (method_exists($model, $action)) {
            ...
            die("<strong>action$actionName</strong> not fond!");
    }
